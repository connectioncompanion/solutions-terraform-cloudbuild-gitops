...
module "cs-gg-prod1-service" {
  ...
  id           = "prod1-service@connectioncompanion.com"
...
module "cs-gg-prod2-service" {
  ...
  id           = "prod2-service@connectioncompanion.com"
...
module "cs-gg-nonprod1-service" {
  ...
  id           = "nonprod1-service@connectioncompanion.com"
...
module "cs-gg-nonprod2-service" {
  ...
  id           = "nonprod2-service@connectioncompanion.com"
