module "cs-folders-iam-0-computeinstanceAdminv1" {
  ...
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
      "group:gcp-developers@connectioncompanion.com",
    ]
  }
}
...
module "cs-folders-iam-0-mladmin" {
  source  = "terraform-google-modules/iam/google//modules/folders_iam"
  version = "~> 7.7"
...
module "cs-folders-iam-0-aiplatformadmin" {
  source  = "terraform-google-modules/iam/google//modules/folders_iam"
  version = "~> 7.7"
...
module "cs-folders-iam-1-aiplatformadmin" {
  source  = "terraform-google-modules/iam/google//modules/folders_iam"
  version = "~> 7.7"
...
module "cs-folders-iam-1-mladmin" {
  source  = "terraform-google-modules/iam/google//modules/folders_iam"
  version = "~> 7.7"
...
module "cs-projects-iam-2-loggingviewer" {
  ...
  bindings = {
    "roles/logging.viewer" = [
      "group:gcp-logging-monitoring-viewers@connectioncompanion.com",
    ]
  }
}
...
module "cs-projects-iam-3-bigquerydataViewer" {
  ...
  bindings = {
    "roles/bigquery.dataViewer" = [
      "group:gcp-security-admins@connectioncompanion.com",
    ]
  }
}
...
module "cs-service-projects-iam-4-mladmin" {
  source  = "terraform-google-modules/iam/google//modules/projects_iam"
  version = "~> 7.7"
...
module "cs-service-projects-iam-6-mladmin" {
  source  = "terraform-google-modules/iam/google//modules/projects_iam"
  version = "~> 7.7"
